...
//import protocol.common.MensajeProtocolo.MalMensajeProtocoloException;
//import protocol.servidor.Sirviente;
...
public class Cliente {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    try {
      ...
      pruebaPeticionRespuesta(new MensajeProtocolo(Primitiva.PULL_SOLOLEE, mensaje));
