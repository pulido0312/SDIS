...
public class PULL_NOTDESTROYED {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    String clave = args[1]; // clave para Primitiva.PULL_NOTDESTROYED
    ...
    try {
      ...
      pruebaPeticionRespuesta(new MensajeProtocolo(Primitiva.PULL_NOTDESTROYED, clave));
