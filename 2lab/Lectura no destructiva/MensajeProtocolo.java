...
public class MensajeProtocolo implements java.io.Serializable {
  ...
  /* Constructor para HELLO, PULL_OK, PULL_WAIT, PULL_NOWAIT, SEEK_OK, SEEK */

  public MensajeProtocolo(Primitiva p, String mensaje)

      throws MalMensajeProtocoloException {

    if (p == Primitiva.HELLO || p == Primitiva.PULL_OK || p == Primitiva.SEEK_OK) {

      this.mensaje = mensaje;

      this.idCola  = null;

    } else if (p == Primitiva.PULL_WAIT || p == Primitiva.PULL_NOWAIT || p == Primitiva.SEEK) {
