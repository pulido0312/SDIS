...
public class Cliente {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    try {
      ...
      // Creacion de los canales de serializacion de objetos      
      ...
      pruebaPeticionRespuesta(new MensajeProtocolo(Primitiva.SEEK, "010"));
      ...
      // a estas alguras algun cliente externo deberua insertar un mensaje en la cola
  ...
  /* Prueba una interaccion de escritura y lectura con el servidor */
